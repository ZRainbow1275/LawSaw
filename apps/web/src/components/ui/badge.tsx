	...
	"inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors",
	{
		variants: {
			variant: {
				...
				industry: "bg-industry/10 text-industry border border-industry/20",
				compliance:
					"bg-compliance/10 text-compliance border border-compliance/20",
				data: "bg-data/10 text-data border border-data/20",
				security: "bg-security/10 text-security border border-security/20",
				academic: "bg-academic/10 text-academic border border-academic/20",
				events: "bg-events/10 text-events border border-events/20",
				international:
