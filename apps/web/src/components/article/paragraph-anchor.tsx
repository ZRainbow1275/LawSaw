...
export function ParagraphAnchor({ id, children, className }: ParagraphAnchorProps) {
 ...
 * 用于包装已渲染的 HTML 内容
 */
interface ArticleWithAnchorsProps {
  content: string;
  className?: string;
}

export function ArticleWithAnchors({ content, className }: ArticleWithAnchorsProps) {
  // 注意：实际实现需要在服务端或客户端解析 HTML 并注入锚点
  // 这里提供基础结构，具体实现依赖于内容解析策略
  return (
