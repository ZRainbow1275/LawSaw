...
import type { ArticleAiInsights, AiEntity } from "@/lib/api/types";
...
const entityIconMap: Record<AiEntity["entity_type"], React.ComponentType<{ className?: string }>> = {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {/* 风险等级指示器 */}
          <div className={cn("flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium", riskConfig.bgColor, riskConfig.color)}>
        ...
        {isExpanded && (
          ...
          >
            <div className="px-4 pb-4 space-y-5 border-t border-neutral-100">
              ...
              {insights.entities.length > 0 && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {insights.entities.slice(0, 8).map((entity, index) => {
              ...
              {/* 风险维度（仅高风险时显示） */}
              {(insights.risk_level === "high" || insights.risk_level === "critical") &&
                insights.risk_dimensions.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-2">
                      {insights.risk_dimensions.map((dim, index) => (
                          ...
                          <div className="flex-1 h-1.5 bg-neutral-100 rounded-full overflow-hidden">
                            <div
                              className={cn(
                                ...
                                dim.score >= 75 ? "bg-error" :
                                dim.score >= 50 ? "bg-orange-500" :
                                dim.score >= 25 ? "bg-warning" : "bg-success"
                              )}
...
export function AiInsightsBrief({
  ...
  return (
    <div className={cn("flex items-start gap-3 p-3 rounded-lg bg-neutral-50", className)}>
