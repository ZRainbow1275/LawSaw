			...
			<div className="border-b border-neutral-100 p-4 dark:border-white/10">
				<div className="flex items-center gap-2">
					...
					<div className="min-w-0">
						<div className="text-sm font-semibold text-neutral-900 dark:text-neutral-50 dark:text-neutral-50">
							{t("Entity panel")}
						</div>
						<div className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">
				...
				{!selectedEntityId ? (
					<div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-5 text-sm text-neutral-700 dark:border-white/10 dark:bg-white/5 dark:text-neutral-200">
						<div className="flex items-start gap-3">
							<div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-neutral-600 shadow-sm dark:bg-neutral-900 dark:text-neutral-300 dark:text-neutral-600">
							...
							<div className="min-w-0">
								...
								<p className="mt-1 text-xs text-neutral-600 dark:text-neutral-300 dark:text-neutral-600">
									{t(
					...
					<div className="flex items-center justify-center py-10 text-sm text-neutral-600 dark:text-neutral-300 dark:text-neutral-600">
					...
					<div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-700 dark:border-white/10 dark:bg-white/5 dark:text-neutral-200">
						{t(
					...
					<div className="space-y-5">
						<div>
							...
							<div className="mt-2 rounded-2xl border border-neutral-200 bg-white p-4 dark:border-white/10 dark:bg-neutral-900">
								<div className="text-base font-semibold text-neutral-900 dark:text-neutral-50">
									{entity.name}
								</div>
								<div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-neutral-600">
									<span className="rounded-full border border-neutral-200 bg-neutral-50 px-2 py-0.5 dark:border-white/10 dark:bg-white/5">
										{entity.entity_type}
									</span>
								...
								<div className="mt-3 text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">
									<div>
						...
						<div>
							...
							{!canSeeArticles ? (
								...
								<div className="mt-2 flex items-center text-sm text-neutral-600 dark:text-neutral-300 dark:text-neutral-600">
									<Loader2
										aria-hidden="true"
								...
								<div className="mt-2 rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-700 dark:border-white/10 dark:bg-white/5 dark:text-neutral-200">
								...
								<div className="mt-2 space-y-2">
									{articles.map((article) => (
										<div
											...
											className="flex items-start justify-between gap-3 rounded-xl border border-neutral-200 bg-white p-3 dark:border-white/10 dark:bg-neutral-900"
										>
											<div className="min-w-0">
												<div className="flex items-center gap-2">
													<FileText
													...
													<Link
														...
														className="truncate text-sm font-medium text-neutral-900 hover:text-primary-700 dark:text-neutral-100 dark:hover:text-primary-300"
													>
														{article.title}
													</Link>
												</div>
