...
- [ ] [FE-ERR-302] 统计分析页在 sources/categories/trends 异常时展示 `0/空图`，易误导决策 ✅ 改为 `—/错误态/重试`，避免将“错误”伪装成“真实 0” - `apps/web/src/app/analytics/page.tsx`
- [ ] [FE-UX-303] 缺少全局 `error.tsx/not-found.tsx`（白屏/404 无反馈） ✅ 补齐全局错误边界与 404 页面（可重试/返回首页）- `apps/web/src/app/{error,not-found}.tsx`
