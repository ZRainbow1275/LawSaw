...
- [ ] [V26-H002] API Client 层无自动重试 - `client.ts` | 全文 (2.6audit.md:46)
- [ ] [V26-H003] 无防抖节流实现 - 搜索功能 | - (2.6audit.md:47)
- [ ] [V26-H004] 无 Background Sync API - `sw/route.ts` (2.6audit.md:79)
- [ ] [V26-H005] 无推送通知 (Web Push) - 全局 (2.6audit.md:80)
- [ ] [V26-H006] **无冲突解决 UI** - Last-write-wins 隐式策略 (2.6audit.md:94)
- [ ] [V26-H007] Worker 缺少 HTTP 健康端点 - `worker/main.rs` (2.6audit.md:106)
- [ ] [V26-H008] `law-eye-api/src/routes/articles.rs` | **1059** - 拆分查询/命令 (2.6audit.md:135)
- [ ] [V26-H009] **chunks 逐条 INSERT** - `main.rs` | 875-903 (2.6audit.md:147)
- [ ] [V26-H010] 仅使用 offset 分页 - 所有列表 API (2.6audit.md:192)
- [ ] [V26-H011] 文章内容无长度限制 - 无 max_body_size 验证 (2.6audit.md:215)
- [ ] [V26-H012] 硬编码中文字符串 - 58个文件 (2.6audit.md:223)
- [ ] [V26-H013] 无测试覆盖率工具 - 无 tarpaulin/istanbul (2.6audit.md:230)
- [ ] [V26-H014] 邮箱验证 - 未实现 (2.6audit.md:241)
- [ ] [V26-H015] DB 成功但 Redis 入队失败无回滚 - `worker/main.rs` (2.6audit.md:262)
- [ ] [V26-H016] **无蓝绿/金丝雀部署** - - (2.6audit.md:283)
- [ ] [V26-H017] **无回滚机制** - - (2.6audit.md:284)
- [ ] [V26-H018] API 层无幂等 key - 无 Idempotency-Key header (2.6audit.md:299)
- [ ] [V26-H019] 无事件版本控制 - 无 event_version 字段 (2.6audit.md:307)
- [ ] [V26-H020] 前后端类型未同步 - 无 TypeScript 类型生成 (2.6audit.md:315)
- [ ] [V26-H021] 无孤儿对象清理任务 - - | - (2.6audit.md:332)
