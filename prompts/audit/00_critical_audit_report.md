...
- [x] [SEC-011] Docker 本地栈 root init 最小能力 ✅：避免递归 `chown -R`（仅修复卷根目录权限；cap 仍仅 `CHOWN`） - `docker-compose.yml`
...
- [x] [VER-014] `cargo test --workspace` ✅（2026-02-04；SEC-011）
- [x] [VER-015] `pnpm -C apps/web lint` ✅（2026-02-04；SEC-011）
- [x] [VER-016] `pnpm -C apps/web test` ✅（2026-02-04；SEC-011）
